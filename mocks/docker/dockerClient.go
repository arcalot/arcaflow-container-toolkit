...
// Source: go.arcalot.io/arcaflow-container-toolkit/internal/docker (interfaces: DockerClient)
...
func (m *MockDockerClient) ImagePush(arg0 context.Context, arg1 string, arg2 image.PushOptions) (io.ReadCloser, error) {
	m.ctrl.T.Helper()
