...
func (m *MockContainerEngineService) Build(filepath, name string, tags []string) error {
	m.ctrl.T.Helper()
...
func (mr *MockContainerEngineServiceMockRecorder) Build(filepath, name, tags interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Build", reflect.TypeOf((*MockContainerEngineService)(nil).Build), filepath, name, tags)
}
